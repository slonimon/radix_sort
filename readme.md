 ...
 * В директории __max_sort_reg_conf__ представлен вариант реализации дизайна внутрунних модулей проекта с применением последовательственной логики с целью повышения частоты тактирования дизайна. Данный вариант ориентировочный, был проверен на базовом тестбенче и имлементирован в конфигурации [M = 32, W = 32, N = 7], результаты имплементации проекта в данной конфигурации параметров приведены на скринах ниже.
