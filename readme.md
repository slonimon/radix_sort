...
### Мконвейеризация внутренних модулей проекта для повышения рабочей тактовой частоты.
 * В директории __max_sort_reg_conf__ представлен вариант реализации дизайна внутрунних модулей проекта с применением последовательственной логики с целью повышения частоты тактирования дизайна. Данный вариант ориентировочный, был проверен на базовой тестбенче и имлементирован в конфигурации [M = 32, W = 32, N = 7], результаты имплементации проекта в данной конфигурации параметров приведены на скринах ниже.

 >![WNS_reg]( WNS_reg.png) 
 >Рис. 8. Результаты временного анализа (критический путь) проекта

 >![Timing_Summary](Timing_Summary.png) 
 >Рис. 8. Timing_Summary проекта

 >![Timing_Summary](Report_Utilization.png) 
 >Рис. 8. Report_Utilization проекта
