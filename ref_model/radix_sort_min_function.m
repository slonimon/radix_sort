...
%%  Radix Sort Min Ref Model %
function [y_out_disp, y_out, o_chi, o_chi_ij_modif] = radix_sort_min_function(M, N, W, i_chi)
...
o_chi =  i_chi;
o_chi_ij_modif = o_chi_ij_modif_disp;
%%
