...
if mod_work == 1
    for w = 1 : 1 : W
        [y_out_disp(w, :), o_chi_ij_modif_disp, y_out(w, :), o_chi_ij_modif] = sort_stage_max(i_chi, N, M);
...
%% sort_stage_max
function [y_out_disp, o_chi_ij_modif_disp, y_out, o_chi_ij_modif] = sort_stage_max(i_chi, N, M)
%% H - matrix calculate
